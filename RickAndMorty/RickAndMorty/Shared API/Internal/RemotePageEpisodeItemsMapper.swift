//
//  RemotePageEpisodeItemsMapper.swift
//  RickAndMorty
//
...
final class RemotePageEpisodeItemsMapper {
    ...
    private struct RemotePageEpisodeItems: Decodable, Equatable {
    ...
    private struct RemotePageInfo: Decodable, Equatable {
        let count: Int
        let pages: Int
        let prev: URL?
        let next: URL?
    ...
    private struct RemoteEpisodeItem: Decodable, Equatable {
        let id: Int
        let name: String
        let airDate: String
        let episode: String
